<?php if (!defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class Sendmail {
        ...
        var $Fromval     = 'ratnesh.lambhate@consagous.com';
        var $FromNameval = 'Consagous Us';
        var $Hostnameval = 'http://192.168.1.162';
        var $Portval     = '587';
        ...
        function sendmailto($emailId,$messageSubject,$messageBody)
        {
