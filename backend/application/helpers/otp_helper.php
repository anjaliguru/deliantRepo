...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    function sendOtp($mobileno,$name){
        $CI = get_instance();
        ...
        $otp_master_data = $CI->common_methods->get_otp_master();
            ...
            $otp_array['tran_id']   = (!empty($_SESSION['__ci_last_regenerate'])) ? $_SESSION['__ci_last_regenerate'] : '';
            ...
            $mobileno   = $mobileno;
            $message    = str_replace(array('##NAME##', '##OTP##'), array($name, $otp) , $otp_master_data->otp_template); 
